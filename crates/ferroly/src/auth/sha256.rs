//! From-scratch SHA-256 and HMAC-SHA256 (FIPS 180-4 / RFC 2104), dep-free —
//! the crypto primitive behind HS256 JWTs. Kept internal.
...
pub(crate) fn hmac_sha256(key: &[u8], msg: &[u8]) -> [u8; 32] {
    // Keys longer than the block size are hashed first; then zero-padded.
